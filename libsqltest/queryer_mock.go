...
// QueryerMock implements libsql.Queryer
...
// NewQueryerMock returns a mock for libsql.Queryer
...
func (mmScan *mQueryerMockScan) Expect(ctx context.Context, scanner mm_libsql.RowScanner, sql string, args ...interface{}) *mQueryerMockScan {
...
func (mmScan *mQueryerMockScan) Inspect(f func(ctx context.Context, scanner mm_libsql.RowScanner, sql string, args ...interface{})) *mQueryerMockScan {
...
func (mmScan *mQueryerMockScan) Set(f func(ctx context.Context, scanner mm_libsql.RowScanner, sql string, args ...interface{}) (err error)) *QueryerMock {
	if mmScan.defaultExpectation != nil {
...
// Then helper
func (mmScan *mQueryerMockScan) When(ctx context.Context, scanner mm_libsql.RowScanner, sql string, args ...interface{}) *QueryerMockScanExpectation {
	if mmScan.mock.funcScan != nil {
		mmScan.mock.t.Fatalf("QueryerMock.Scan mock is already set by Set")
	}
...
// Scan implements libsql.Queryer
func (mmScan *QueryerMock) Scan(ctx context.Context, scanner mm_libsql.RowScanner, sql string, args ...interface{}) (err error) {
...
func (mmScanOne *mQueryerMockScanOne) Expect(ctx context.Context, scanner mm_libsql.RowScanner, sql string, args ...interface{}) *mQueryerMockScanOne {
...
func (mmScanOne *mQueryerMockScanOne) Inspect(f func(ctx context.Context, scanner mm_libsql.RowScanner, sql string, args ...interface{})) *mQueryerMockScanOne {
...
func (mmScanOne *mQueryerMockScanOne) Set(f func(ctx context.Context, scanner mm_libsql.RowScanner, sql string, args ...interface{}) (err error)) *QueryerMock {
	if mmScanOne.defaultExpectation != nil {
...
// Then helper
func (mmScanOne *mQueryerMockScanOne) When(ctx context.Context, scanner mm_libsql.RowScanner, sql string, args ...interface{}) *QueryerMockScanOneExpectation {
	if mmScanOne.mock.funcScanOne != nil {
		mmScanOne.mock.t.Fatalf("QueryerMock.ScanOne mock is already set by Set")
	}
...
// ScanOne implements libsql.Queryer
func (mmScanOne *QueryerMock) ScanOne(ctx context.Context, scanner mm_libsql.RowScanner, sql string, args ...interface{}) (err error) {
...
// Update implements libsql.Queryer
...
// UpdateAndGetLastInsertID implements libsql.Queryer
...
// UpdateAndGetRowsAffected implements libsql.Queryer
