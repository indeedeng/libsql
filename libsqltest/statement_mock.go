...
// StatementMock implements libsql.Statement
...
// NewStatementMock returns a mock for libsql.Statement
...
func (mmScan *mStatementMockScan) Expect(ctx context.Context, scanner mm_libsql.RowScanner, args ...interface{}) *mStatementMockScan {
...
func (mmScan *mStatementMockScan) Inspect(f func(ctx context.Context, scanner mm_libsql.RowScanner, args ...interface{})) *mStatementMockScan {
...
func (mmScan *mStatementMockScan) Set(f func(ctx context.Context, scanner mm_libsql.RowScanner, args ...interface{}) (err error)) *StatementMock {
	if mmScan.defaultExpectation != nil {
...
// Then helper
func (mmScan *mStatementMockScan) When(ctx context.Context, scanner mm_libsql.RowScanner, args ...interface{}) *StatementMockScanExpectation {
	if mmScan.mock.funcScan != nil {
		mmScan.mock.t.Fatalf("StatementMock.Scan mock is already set by Set")
	}
...
// Scan implements libsql.Statement
func (mmScan *StatementMock) Scan(ctx context.Context, scanner mm_libsql.RowScanner, args ...interface{}) (err error) {
...
func (mmScanOne *mStatementMockScanOne) Expect(ctx context.Context, scanner mm_libsql.RowScanner, args ...interface{}) *mStatementMockScanOne {
...
func (mmScanOne *mStatementMockScanOne) Inspect(f func(ctx context.Context, scanner mm_libsql.RowScanner, args ...interface{})) *mStatementMockScanOne {
...
func (mmScanOne *mStatementMockScanOne) Set(f func(ctx context.Context, scanner mm_libsql.RowScanner, args ...interface{}) (err error)) *StatementMock {
	if mmScanOne.defaultExpectation != nil {
...
// Then helper
func (mmScanOne *mStatementMockScanOne) When(ctx context.Context, scanner mm_libsql.RowScanner, args ...interface{}) *StatementMockScanOneExpectation {
	if mmScanOne.mock.funcScanOne != nil {
		mmScanOne.mock.t.Fatalf("StatementMock.ScanOne mock is already set by Set")
	}
...
// ScanOne implements libsql.Statement
func (mmScanOne *StatementMock) ScanOne(ctx context.Context, scanner mm_libsql.RowScanner, args ...interface{}) (err error) {
...
// Update implements libsql.Statement
...
// UpdateAndGetLastInsertID implements libsql.Statement
...
// UpdateAndGetRowsAffected implements libsql.Statement
